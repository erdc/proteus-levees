...
#he*=0.5
H=10.0
domain = gl_3_3d(width=he,h=H)
domain.regionConstraints = [hl**3/6,hd**3/6,hl**3/6]
...
SRF_init=0.2
g = [0.0,0.0,-9.8]
rhos = 1.7347 #tonnes/m^3 = 1000 kg/m^3
...
soilModelFlag=1
phi_mc = atan(tan((0.0/360.0)*2.0*math.pi)/SRF) #friction angle; note phi=0 for example 3
