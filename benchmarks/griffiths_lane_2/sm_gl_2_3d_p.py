...
"""
Soil mechanics model for problem 6.2 in Smith and Griffiths
"""
nd=3
from griffiths_lane_2 import *
genMesh=True
he = 1.0
#he*=0.5
#he*=0.5
...
H=10.0
D=1.5
domain = gl_2_3d(width=he,h=H,d=D)
domain.regionConstraints = [he]
...
SRF_init=1.0
g = [0.0,0.0,-9.8]
rhos = 1.7347 #tonnes/m^3
rhow = 0.998 #tonnes/m^3
...
soilModelFlag=1
phi_mc = atan(tan((20.0/360.0)*2.0*math.pi)/SRF) #friction angle
c_mc = 0.05*rhos*fabs(g[2])*H
